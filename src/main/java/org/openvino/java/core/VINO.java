...
public interface VINO extends Library {
     ...
     * @return Status code of the operation: OK(0) for success.
     */
    int ov_preprocess_preprocess_steps_crop(Pointer preprocessInputProcessSteps, Pointer begin, int beginSize, Pointer end, int endSize);
     ...
     * @return Status code of the operation: OK(0) for success.
     */
    int ov_preprocess_preprocess_steps_convert_layout(Pointer preprocessInputProcessSteps, Pointer layout);
